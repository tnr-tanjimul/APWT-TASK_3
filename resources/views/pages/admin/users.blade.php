                        ...
                        <table class="table table-centered table-nowrap table-striped" id="products-datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/admin/edit/{{$data->id}}" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                        <a href="/admin/delete/{{$data->id}}" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                    </td>
                                </tr>
                                @endforeach
            ...
            <div class="modal-body p-4">
                <form action="{{route('admin.userlist')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="dnsName" name="dnsName" placeholder="Enter dns Name" required="">
                    </div>
